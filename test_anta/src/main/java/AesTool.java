...
public class AesTool {
     ...
     */
    public static String encrypt(String encryptStr, String key) throws Exception {
        //待加密字符串为空
     ...
     */
    public static String decrypt(String decryptStr, String key) throws Exception {
        //待解密字符串为空
     ...
     * @return byte[]
     */
    private static byte[] md5(String key) throws Exception {
        try {
            //生成MD5定长秘钥算法模式.
